...
export default function LandingPage() {
  return (
    <div className="bg-black overflow-x-hidden">
      ...
      <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pt-28 sm:pt-32 pb-20 overflow-hidden">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2">
          ...
          <h1 className="font-serif relative text-5xl sm:text-6xl lg:text-7xl tracking-tighter max-w-4xl">
            <GrayTitle>Refine your interview edge</GrayTitle>
            <br />
            <GoldTitle>with real expertise</GoldTitle>
          </h1>
      ...
      {/* PRICING */}
      <section className="relative z-0 pb-28 max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
        ...
        <style dangerouslySetInnerHTML={{
          __html: `
          /* 1. Force the internal Clerk cards container to follow responsive grid rules */
          .cl-internal-b8hinb, .cl-pricingCards {
          ...
          /* 2. Custom Smooth Pop-In & Pop-Out for the checkout modal */
          .clerk-modal-override {
            transform: translate(-50%, -50%) !important;
            transition: none !important;
            animation: clerkPopIn 0.25s cubic-bezier(0.16, 1, 0.3, 1) forwards !important;
          }
          
          /* Radix UI state for closing */
          [data-state="closed"] .clerk-modal-override, 
          .clerk-modal-override[data-state="closed"] {
            animation: clerkPopOut 0.2s ease-in forwards !important;
          }

          @keyframes clerkPopIn {
            from { opacity: 0; transform: translate(-50%, -50%) scale(0.95); }
            to { opacity: 1; transform: translate(-50%, -50%) scale(1); }
          }
          @keyframes clerkPopOut {
